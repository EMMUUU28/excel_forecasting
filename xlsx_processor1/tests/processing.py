...
from xlsx_processor import settings
...
def main():
    """
    Main function to execute data processing with static arguments.
    """
    ...
    output_folder_path = os.path.join(processed_dir, 'myfinalreports' )
    os.makedirs(output_folder_path, exist_ok=True)
    file_path = os.path.join(processed_dir,output_folder_path)

    # Static arguments
    input_path = r"C:\Users\emman\Downloads\VerticalReport_Planning 43.xlsx"
    ...
    process_data(input_path, file_path, month_from, month_to, percentage)
    end_time = time.time() 
