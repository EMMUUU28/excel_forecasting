...
def add_data_to_sheet(INPUT_EXCEL_FILE, OUTPUT_EXCEL_FILE):
    ...
    if 'TAB' in metal_df1.columns:
        ...
        for tab in tab_categories:
            ...
            print(f"Total execution time with multiprocessing: {end_time - start_time:.6f} seconds")
...
INPUT_EXCEL_FILE='test_pricing_sheets.xlsx'
OUTPUT_EXCEL_FILE='new_output_adjusted2.xlsx'
add_data_to_sheet(INPUT_EXCEL_FILE, OUTPUT_EXCEL_FILE)