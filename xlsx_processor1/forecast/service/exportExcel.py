from .createDataframe import report_grouping_df,index_df
from .sales_forecasting_algorithmpartwithcom_new_log import *
...
def process_data(input_path, file_path, month_from, month_to, percentage, input_tuple):
    ...
    for category, code, num_products in dynamic_categories:
        ...
        final_data[output_file] = {"Pid_to_review": pids_below_door_count, "Pid_to_birthstone": birthstone_list ,  "Pid_to_notify_to_macy":notify_macys,   "Pid_to_Store_product": store_products}
